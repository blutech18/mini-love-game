...
export const playlist: Track[] = [
  { id: 1, title: "Perfect", artist: "Ed Sheeran", emoji: "🎶", src: "" },
  { id: 2, title: "Can't Help Falling in Love", artist: "Elvis Presley", emoji: "💿", src: "" },
  { id: 3, title: "All of Me", artist: "John Legend", emoji: "🎹", src: "" },
  { id: 4, title: "A Thousand Years", artist: "Christina Perri", emoji: "⏳", src: "" },
  { id: 5, title: "Thinking Out Loud", artist: "Ed Sheeran", emoji: "🎸", src: "" },
  { id: 6, title: "Lullaby", artist: "Ambient Dreams", emoji: "🌙", src: "" },
  { id: 7, title: "Sunshine After Rain", artist: "Happy Vibes", emoji: "☀️", src: "" },
];
...
export const menuItems = [
  { id: "OUR_STORY", label: "Our Story", emoji: "📖", description: "Our journey together" },
  { id: "LETTERS", label: "Letters", emoji: "💌", description: "Words from my heart" },
  { id: "COMFORT_ZONE", label: "Comfort Zone", emoji: "🫂", description: "When you need me" },
  { id: "MUSIC_ROOM", label: "Music Room", emoji: "🎵", description: "Our playlist" },
] as const;
